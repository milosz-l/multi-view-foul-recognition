...
EVENT_DICTIONARY_offence_severity_class = {
    "No offence": 0, "Offence + No card": 1, "Offence + Yellow card": 2, "Offence + Red card": 3}
...
EVENT_DICTIONARY_offence_class = {
    "Offence": 0, "Between": 1, "No Offence": 2, "No offence": 2}

INVERSE_EVENT_DICTIONARY_offence_class = {
    0: "Offence", 1: "Between", 2: "No Offence"}
...
INVERSE_EVENT_DICTIONARY_severity_class = {
    0: "No card", 1: "Borderline No/Yellow", 2: "Yellow card", 3: "Borderline Yellow/Red", 4: "Red card"}
